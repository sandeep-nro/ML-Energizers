...
automl_run_id = 'AutoML_c8ca19b0-0bff-45a9-9ca9-834a338b0ef1_41'
...
def prepare_data(dataframe):
    ...
    label_column_name = 'ElectricityUsekWh'
...
def generate_data_transformation_config():
    ...
    column_group_0 = [['CO2'], ['AtticRoomTemperature'], ['LivingActualTemperature'], ['OutsideActualTemperature'], ['MotionDetectedCounter'], ['UnderfloorActualTemperature'], ['TotalElectricityUsekWh'], ['sunHour'], ['moon_illumination'], ['FeelsLikeC'], ['HeatIndexC'], ['WindChillC'], ['WindGustKmph'], ['cloudcover'], ['humidity'], ['precipMM'], ['pressure'], ['tempC'], ['winddirDegree']]
...
def generate_algorithm_config():
    ...
    '''
    from azureml.training.tabular.models.stack_ensemble import StackEnsembleRegressor
    from sklearn.linear_model import ElasticNetCV
    ...
    algorithm = StackEnsembleRegressor(
        base_learners=[
            ('model_0', pipeline_0),
        ],
